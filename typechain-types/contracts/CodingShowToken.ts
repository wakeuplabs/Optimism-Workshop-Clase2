...
export interface CodingShowTokenInterface extends utils.Interface {
  functions: {
...
export interface CodingShowToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CodingShowTokenInterface;
